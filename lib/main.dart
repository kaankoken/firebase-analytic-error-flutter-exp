...
void main() async {
  ...
  // Emulation of pre load of libraries
...
Future<void> setUserId() async {
  ...
  superProperties.putIfAbsent('isFree', () => true);
  superProperties.putIfAbsent('optIn', () => true);
  superProperties.putIfAbsent('isGranted', () => true);

  firebaseAnalytics.setDefaultEventParameters(superProperties);

  FirebaseCrashlytics.instance.setCustomKey('email', 'email');
  FirebaseCrashlytics.instance.setCustomKey('uuid', 'id');
}
